...
```{r, include=FALSE}
# root.dir est deja configure sur le dossier de donnees
```
...
```{r, include=FALSE}
iris_shp <- st_read(file.path(raw_dir, "georef-france-iris-millesime.shp"), crs = "WGS84")
sirene_shp <- st_read(file.path(raw_dir, "dataseed-sirene-2.shp"), crs = "WGS84")
