---
title: "Geomarketing avec R - Session 2 (Isochrone 10 min + Features)"
output:
  html_document:
    df_print: paged
...
write.csv(data_temp2, file.path(processed_dir, "nb_pdv_iris_iso10.csv"), row.names = FALSE)
```
```{r, eval=use_otp && otp_available}
...
st_write(
  iris_grenoble,
  file.path(processed_dir, "iris_grenoble_iso10.gpkg"),
  delete_dsn = TRUE
)
```
